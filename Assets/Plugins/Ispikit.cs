...
// Below are the available plugin calls for all supported platforms
	...
	public void initCallback(int status) {
		...
		setCompletionCallback (new completionCallbackDelegate( Ispikit.completionCallback ));
		setNewWordsCallback (new newWordsCallbackDelegate( Ispikit.newWordsCallback ));
		setNewAudioCallback (new newAudioCallbackDelegate( Ispikit.newAudioCallback ));
		setPlaybackDoneCallback (new playbackDoneCallbackDelegate( Ispikit.playbackDoneCallback ));
#endif
